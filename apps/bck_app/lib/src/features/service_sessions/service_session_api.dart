...
class ServiceSessionApi {
  ...
  Future<ServiceSession> updateNotes(String id,String? notes)async{final response=await _dio.put<Map<String,dynamic>>('/api/v1/service-sessions/$id/notes',data:{'notes':notes},options:_authorized());return ServiceSession.fromJson(response.data!);}
